...
list_of_files = [ file_1, file_2, file_3, file_4, file_5, file_6, file_7, file_8, file_9, file_10, file_11 ]
...
for file in list_of_files: # cross validation, one file will be considered as testing file, the others as traning files
    ...
    # clf = svm.SVC(gamma=0.001, C=100.) # svc didn't work... ?
    ...
    for i in vectors:
        pronoun_id = api.get_full_id( i[0])
        referent_id = api.get_full_id( i[1])
        triplet = ( pronoun_id, referent_id, bool(i[3]) )
